...
export function mapSenditPayload(payload) {
  ...
  */
  ...
  return {
    ...
    customer_name: pick(payload, ["customer.name", "customer.full_name", "client.name", "recipient.name", "receiver.name", "name", "customer_name", "client_name", "recipient_name", "data.customer.name", "data.name"], "Unknown customer"),
    phone: pick(payload, ["customer.phone", "customer.telephone", "client.phone", "recipient.phone", "receiver.phone", "phone", "telephone", "customer_phone", "client_phone", "data.customer.phone", "data.phone"], ""),
    city: pick(payload, ["customer.city", "client.city", "recipient.city", "receiver.city", "city", "data.customer.city", "data.city", "delivery.city"], ""),
    address: pick(payload, ["customer.address", "client.address", "recipient.address", "receiver.address", "address", "data.customer.address", "data.address", "delivery.address"], ""),
    product_name: pick(payload, ["product.name", "product_name", "item.name", "item.title", "items.0.name", "data.product.name", "data.product_name"], ""),
    amount: Number(pick(payload, ["amount", "price", "cod_amount", "order.amount", "data.amount", "data.price", "total"], 0)),
