...
export const api = {
  ...
  updateOrderDetails: (id, body) => request(`/api/orders/${id}/details`, { method: "POST", body: JSON.stringify(body) }),
  syncSenditOrder: (id) => request(`/api/orders/${id}/sync-sendit`, { method: "POST" }),
  followup: (id, body) => request(`/api/orders/${id}/followup`, { method: "POST", body: JSON.stringify(body) }),
  markDone: (id, body) => request(`/api/orders/${id}/done`, { method: "POST", body: JSON.stringify(body) }),
  ...
  activity: (range = "today") => request(`/api/followups/activity?range=${range}`),
